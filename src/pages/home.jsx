...
export const Home = () =>{
    return (
        ...
        <section>
        <h1>home</h1>
        <p>Bem-vindo ao Petshop "Melhor Amigo"!</p>
        <img src={imagemPrincipal} />
        <p className='apresentacao'>No Petshop "Melhor Amigo", nós entendemos que seu animal de estimação é
          ...
          feliz e saudável.</p>
        <p>Com uma equipe dedicada e apaixonada por animais, nossos profissionais
          ...
          todo o processo.</p>
        <p className='produtos'>Sabemos que a alimentação é fundamental para a saúde do seu pet, por isso
          ...
          animalzinho.</p>
        <p className='fotos'>Nossa galeria de fotos é o reflexo do nosso amor e cuidado pelos animais. Lá,
          ...
          seu bem-estar e felicidade.</p>
        <p className='contatos'>Estamos ansiosos para conhecê-lo e ao seu melhor amigo! Visite-nos no
          ...
          Amigo" para cuidar do seu melhor amigo como se fosse nosso próprio.</p>
      </section>
    )
} 